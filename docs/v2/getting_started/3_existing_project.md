...
If you already have an existing Rails project, just add `gem "spina"` to your Gemfile and run `bundle install`. (Spina works with SQLite by default, but also supports other databases)
